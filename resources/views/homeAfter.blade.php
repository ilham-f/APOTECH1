...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
            <div class="container">
                <div class="image">
                    <img src="assets/img/logo.png" alt="logoApotech" style="display: block; height: 50px;">
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">    
                    ...
                    <ul class="navbar-nav ms-4">
                        <li class="dropdown profil">
                            <a class="nav-link dropdown-toggle" style="padding: 0;" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hussein</span>
                            ...
                            <ul class="dropdown-menu" style="padding: 0; border-radius: 5px;">
                                <li><a class="dropdown-item border-0" href="/profile">Profil</a></li>
                                <li><a class="dropdown-item border-0" href="/home">Keluar</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
