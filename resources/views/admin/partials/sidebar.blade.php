...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Kategori Obat</h6>
                <a class="collapse-item" href="/tabelkategori">Tabel Kategori Obat</a>
                <a class="collapse-item" href="/tambahkategori">Tambah Kategori Obat</a>
            </div>
        </div>
        ...
        <div id="collapsethree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/tabelkeluhan">Tabel Keluhan</a>
                <a class="collapse-item" href="/tambahkeluhan">Tambah Keluhan</a>
            </div>
        </div>
    </li>
